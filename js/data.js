...
const DEFAULT_DATA = {
  personal: {
    name: { ar: "محمد حمدي", en: "Mohamed Hamdy" },
    title: { ar: "مطور واجهات أمامية & طالب هندسة ذكاء اصطناعي", en: "Front-End Developer & AI Engineering Student" },
    phone: "+20 1229719494",
  ...
  about: {
    text: {
      ar: "مطور واجهات أمامية ومهندس برمجيات طموح، لديّ خبرة في إطلاق تطبيقات ويب تركز على المستخدم وتوسيع نطاق المنصات لأكثر من 700 مستخدم. أمتلك أساسًا قويًا في أنظمة JavaScript والقيادة التقنية، وأسعى لتوظيف مهاراتي في تدريب عملي مؤثر في تطوير البرمجيات.",
    ...
    stats: [
      { value: "700+", label: { ar: "مستخدم نشط", en: "Active Users" }, icon: "bx-group" },
      { value: "120+", label: { ar: "طالب تم تدريبه", en: "Students Trained" }, icon: "bx-book-reader" },
      { value: "10+", label: { ar: "مشروع مكتمل", en: "Projects Completed" }, icon: "bx-code-block" },
      { value: "4+", label: { ar: "سنوات خبرة", en: "Years Experience" }, icon: "bx-time-five" }
    ]
  },
  ...
  education: [
    {
      id: "edu-2",
      degree: { ar: "الثانوية العامة", en: "High School Diploma" },
      institution: { ar: "مدرسة طنطا الثانوية", en: "Tanta Secondary School" },
      period: { ar: "2021 — 2024", en: "2021 — 2024" },
      description: { ar: "تخرجت بمجموع 91.2%", en: "Graduated with 91.2% overall score" },
      image: "assets/images/education-1.png"
    },
    {
      id: "edu-1",
      degree: { ar: "هندسة الذكاء الاصطناعي والبرمجيات", en: "AI & Software Engineering" },
      institution: { ar: "كلية الهندسة — جامعة طنطا", en: "Faculty of Engineering — Tanta University" },
      period: { ar: "2024 — الوقت الحاضر", en: "2024 — Present" },
      description: { ar: "دراسة متخصصة في هندسة البرمجيات والذكاء الاصطناعي", en: "Specialized study in Software Engineering and Artificial Intelligence" },
  ...
  experience: [
    {
      id: "exp-1",
      title: { ar: "مدرّب برمجة محترف — عمل حر", en: "Professional Programming Instructor — Self-Employed" },
      period: { ar: "2022 — الوقت الحاضر", en: "2022 — Present" },
      description: {
    ...
    {
      id: "exp-2",
      title: { ar: "مدرّب برمجة | iSchool", en: "Coding Instructor | iSchool" },
      period: { ar: "يونيو 2026", en: "June 2026" },
      description: {
    ...
    {
      id: "exp-3",
      title: { ar: "مدرّب ذكاء اصطناعي وبرمجة — Genial Math", en: "AI & Programming Instructor — Genial Math" },
      period: { ar: "يناير 2026", en: "Jan 2026" },
      description: {
    ...
    {
      id: "exp-4",
      title: { ar: "مدرّب دورات — وزارة التربية والتعليم", en: "Course Instructor — Ministry of Education" },
      period: { ar: "أغسطس 2023 — 2024", en: "Aug 2023 — 2024" },
      description: {
  ...
  skills: {
    languages: [
      ...
      { name: "Sass", icon: "bxl-sass", color: "#CC6699" },
      { name: "Bootstrap", icon: "bxl-bootstrap", color: "#7952B3" },
      { name: "PHP", icon: "bxl-php", color: "#777BB4" },
      { name: "C++", icon: "bx-code-curly", color: "#00599C" },
      { name: "Vue.js", icon: "bxl-vuejs", color: "#4FC08D" }
    ],
    backend: [
      { name: "Firebase", icon: "bx-data", color: "#FFCA28" },
      { name: "Cloud Firestore", icon: "bx-cloud", color: "#FFCA28" },
      { name: "MySQL", icon: "bx-server", color: "#4479A1" },
      { name: "LocalStorage", icon: "bx-hdd", color: "#a1a1aa" }
    ],
    tools: [
      { name: "Git", icon: "bxl-git", color: "#F05032" },
      { name: "GitHub", icon: "bxl-github", color: "#ffffff" },
      { name: "Notion", icon: "bx-notepad", color: "#ffffff" },
      { name: "UI/UX Design", icon: "bx-palette", color: "#8b5cf6" },
      { name: "Responsive Design", icon: "bx-devices", color: "#3b82f6" }
    ]
  },
  ...
  projects: [
    {
      id: "proj-1",
      title: { ar: "محاسبة النفس — متتبع العادات الإسلامية", en: "Mohasabat Al-Nafs — Islamic Habit Tracker" },
      subtitle: { ar: "تطبيق ويب متكامل", en: "Full-Stack Web App" },
      description: {
      ...
      techStack: ["Vanilla JS", "CSS3", "Firebase", "Cloud Firestore"],
    ...
    {
      id: "proj-2",
      title: { ar: "لِتعلَم — منصة تعليم البرمجة", en: "LETA3LAM — Programming Education Platform" },
      subtitle: { ar: "نظام إدارة تعلم (LMS)", en: "Learning Management System (LMS)" },
      description: {
    ...
    {
      id: "proj-3",
      title: { ar: "موقعي الشخصي — Portfolio", en: "Personal Portfolio Website" },
      subtitle: { ar: "موقع شخصي", en: "Portfolio Website" },
      description: {
    ...
    {
      id: "proj-4",
      title: { ar: "معًا — قوانين الأسرة", en: "Ma3an Family Rules" },
      subtitle: { ar: "تطبيق ويب", en: "Frontend Web App" },
      description: {
    ...
    {
      id: "proj-5",
      title: { ar: "موقع لتعلُّم التداول", en: "Learn Trading Website" },
      subtitle: { ar: "موقع تعليمي", en: "Educational Website" },
      description: {
  ...
  ui: {
    heroTexts: {
      ar: ["مطور واجهات أمامية", "مؤسس منصة \"لِتعلَم\"", "طالب هندسة ذكاء اصطناعي", "مسلم معتز بدينه"],
      en: ["Front-End Developer", "Founder of LETA3LAM", "AI Engineering Student", "Proud Muslim"]
    },
    navItems: [
      { id: "home", label: { ar: "الرئيسية", en: "Home" } },
      { id: "about", label: { ar: "عنّي", en: "About" } },
      { id: "education", label: { ar: "التعليم", en: "Education" } },
      { id: "experience", label: { ar: "الخبرات", en: "Experience" } },
    ...
    contactForm: {
      ...
      sendBtn: { ar: "إرسال", en: "Send Message" }
    },
    footer: {
      text: { ar: "جميع الحقوق محفوظة", en: "All Rights Reserved" }
    },
    heroCTA: {
      contact: { ar: "دعنا نتواصل!", en: "Let's Connect!" },
      cv: { ar: "تحميل السيرة الذاتية", en: "Download CV" }
    },
    sectionTitles: {
      about: { ar: "نبذة <span>عنّي</span>", en: "About <span>Me</span>" },
      education: { ar: "التعليم <span>الأكاديمي</span>", en: "My <span>Education</span>" },
      experience: { ar: "الخبرات <span>المهنية</span>", en: "Professional <span>Experience</span>" },
      skills: { ar: "المهارات <span>التقنية</span>", en: "Technical <span>Skills</span>" },
      projects: { ar: "المشاريع <span>الخاصة بي</span>", en: "My <span>Projects</span>" },
      contact: { ar: "تواصل <span>معي</span>", en: "Get In <span>Touch</span>" }
    },
    skillCategoryTitles: {
      languages: { ar: "اللغات والأطر", en: "Languages & Frameworks" },
      backend: { ar: "الخدمات الخلفية وقواعد البيانات", en: "Backend & Databases" },
      tools: { ar: "الأدوات والمنهجيات", en: "Tools & Methodologies" }
    }
  }
};
